...
INICIO  BSF     STATUS,RP0  ;Activamos banco 1
        ...
        CLRF    PORTD       ;Iniciamos con "0" los display.
        ;Programa principal
BOTON0  BTFSS   PORTB,0     ;Pregunta por pulsador0
        GOTO    ANTI0
BOTON1  BTFSS   PORTB,1     ;Pregunta por pulsador1
        GOTO    ANTI1
BOTON2  BTFSS   PORTB,2     ;Pregunta por pulsador2
        GOTO    ANTI2
BOTON3  BTFSS   PORTB,3     ;Pregunta por pulsador3
        GOTO    ANTI3
        GOTO    BOTON0
...
ANTI1   BTFSS   PORTB,1     ;Pregunta si pulsador1 se ha "soltado"
        ...
        DECF    PORTC,F
        GOTO    BOTON2
        ;Rutinas de antirebote 2
ANTI2   BTFSS   PORTB,2     ;Pregunta si pulsador2 se ha "soltado"
        GOTO    ANTI2
        INCF    PORTD,F
        GOTO    BOTON3
        ;Rutinas de antirebote 3
ANTI3   BTFSS   PORTB,3     ;Pregunta si pulsador3 se ha "soltado"
        GOTO    ANTI3
        DECF    PORTD,F
        GOTO    BOTON0
        END