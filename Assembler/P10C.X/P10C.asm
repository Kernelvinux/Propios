...
VOLVER  MOVF    CUENTA,W    ; Cargamos CUENTA a W
        ...
        ;Enviamos dato a segunda matriz
        MOVF    CUENTA,W    ; Cargamos CUENTA a W
        CALL    TABLA2      ; Llamada a subrutina TABLA2
        MOVWF   PORTC       ; Envia dato de TABLA2 a puerto C
        ;Activamos columna
        MOVF    ROTAR,W     
        MOVWF   PORTD
...
TABLA1  ADDWF   PCL, F
        ...
        RETLW   0x00        ; Código del 0 en 7 segmentos
        RETLW   0xFE        ; Código del 0 en 7 segmentos
        RETLW   0xFE        ; Código del 0 en 7 segmentos
        RETLW   0x00        ; Código del 0 en 7 segmentos
...
TABLA2  ADDWF   PCL, F
        ...
        RETLW   0xCF        ; Código del 5 en 7 segmentos
        RETLW   0xE7        ; Código del 6 en 7 segmentos
        RETLW   0x00        ; Código del 7 en 7 segmentos
        RETLW   0x00        ; Código del 0 en 7 segmentos
        RETLW   0xFF        ; Código del 0 en 7 segmentos
        RETLW   0x00        ; Código del 0 en 7 segmentos
        RETLW   0x00        ; Código del 0 en 7 segmentos
        ;Subrutina Apaga Matriz
APAGAR  MOVLW   0x00        ; Cargamos el dato 00 a W
        MOVWF   PORTD       ; "Apagamos tods las columnas de PORTD"
        RETURN
        ;Subrutina de Delay
