...
CUENTA  EQU     0x23        ; Variable para almacenar temporalmente la CUENTA
        ...
        CALL    APAGAR
INICIO  MOVLW   B'00000001' ; Inicializa la variable ROTAR
        MOVWF   ROTAR       ;
...
TABLA   ADDWF   PCL, F
        ...
        RETLW   0x80        ; Código del 1 en 7 segmentos
        RETLW   0x77        ; Código del 2 en 7 segmentos
        RETLW   0x77        ; Código del 3 en 7 segmentos
        RETLW   0x77        ; Código del 4 en 7 segmentos
        RETLW   0x77        ; Código del 5 en 7 segmentos
        RETLW   0x80        ; Código del 6 en 7 segmentos
        RETLW   0xFF        ; Código del 7 en 7 segmentos
        ;************APAGAR DISPLAY********************
APAGAR  MOVLW   0x00        ; Cargamos el dato FF a W
        MOVWF   PORTD       ; Pone 1?s a todos los bits del puerto D
        RETURN
        ;*****************DELAY************************
DELAY   MOVLW   0x100        ; Configuramos el tiempo del Delay
        MOVWF   TIEMPO1
DELAY1  MOVWF   TIEMPO2
DELAY2  DECFSZ  TIEMPO2,F
        GOTO    DELAY2
        DECFSZ  TIEMPO1,F
        GOTO    DELAY1
        RETURN
